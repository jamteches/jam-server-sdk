...
class ChunkedUploadService {
  ...
  Future<Map<String, dynamic>> initUpload({
    ...
    return await _client.post('/upload/init', body: {
      'filename': filename,
  ...
  Future<Map<String, dynamic>> uploadChunk(
    ...
    final path = '/upload/$sessionId/chunk/$chunkIndex';
